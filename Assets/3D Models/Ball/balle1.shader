    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float4 node_4567 = _Time + _TimeEditor;
                float2 node_9547 = (o.uv0+node_4567.g*float2(0.1,0.1));
                float4 node_5501 = tex2Dlod(_node_2291,float4(TRANSFORM_TEX(node_9547, _node_2291),0.0,0));
                float2 node_1470 = (o.uv0+node_4567.g*float2(-0.1,0));
...
////// Emissive:
                float4 node_4567 = _Time + _TimeEditor;
                float2 node_9096 = ((i.uv0*_node_5395)+node_4567.g*float2(1,0));
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                o.normalDir = UnityObjectToWorldNormal(v.normal);
                float4 node_208 = _Time + _TimeEditor;
                float4 node_2411 = _Time + _TimeEditor;
                float2 node_9547 = (o.uv0+node_2411.g*float2(0.1,0.1));
                float4 node_5501 = tex2Dlod(_node_2291,float4(TRANSFORM_TEX(node_9547, _node_2291),0.0,0));
                float2 node_1470 = (o.uv0+node_2411.g*float2(-0.1,0));
                float4 node_671 = tex2Dlod(_node_2291,float4(TRANSFORM_TEX(node_1470, _node_2291),0.0,0));
                v.vertex.xyz += (((0.02*(sin((_node_1240*node_208.g))*1.0+0.0))+(node_5501.rgb*node_671.rgb*0.2))*v.normal);
                o.pos = mul(UNITY_MATRIX_MVP, v.vertex );
