...
////// Lighting:
////// Emissive:
                float4 node_5849 = _Time + _TimeEditor;
                float2 node_265 = ((i.uv0*_node_1728)+node_5849.g*float2(-0.2,-0.2));
                float4 _node_7356_var = tex2D(_node_7356,TRANSFORM_TEX(node_265, _node_7356));
                float2 node_8146 = ((i.uv0*_node_1728_copy)+node_5849.g*float2(0.3,0.3));
